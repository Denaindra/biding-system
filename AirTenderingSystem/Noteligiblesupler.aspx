<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Noteligiblesupler.aspx.cs" Inherits="AirTenderingSystem.Noteligiblesupler" %>
...
<div class="signin">
	<div class="container">
		<div class="signin-main">
			<h1>Not eligible sellers Information</h1><br />
                <asp:TextBox ID="warantee" runat="server" placeholder="warantee" TextMode="Number" Width="450px"  /><br/>
                <asp:TextBox ID="price" runat="server" placeholder="price" TextMode="Number" Width="450px"  />
				<asp:TextBox ID="freight" TextMode="Number" runat="server" class="no-margin" placeholder="freight"  Width="450px"/>
            	<asp:TextBox ID="deliverydate" TextMode="Number" runat="server" class="no-margin" placeholder="Dilivery Date"  Width="450px"/>
