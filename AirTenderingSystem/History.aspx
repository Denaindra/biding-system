<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="History.aspx.cs" Inherits="AirTenderingSystem.History" %>
...
<div class="signin">
	<div class="container">
		<div class="signin-main">
			<h1>Seller</h1>
			<h2>Past history</h2>
            <asp:GridView ID="history" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
