<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminpanel.aspx.cs" Inherits="AirTenderingSystem.adminpanel" %>
        ...
        <div class="container">
            <div class="banner-main">
                ...
                <div class="col-md-6 banner-right simpleCart_shelfItem">
                    ...
                    <h1>Command Procurement Officer Home Page</h1>
                  <%--  <ul class="bann-btns">
                        <li><a href="TenderList.aspx" class="item_add">View New Tenders</a></li>
                    </ul>--%>
                </div>
                <div class="clearfix"> </div>
            </div>
